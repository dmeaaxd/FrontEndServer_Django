...
function selectTypeOfProfit() {
    const profitModel = document.getElementById('profitModal');
    profitModel.style.display = 'block';
}


document.getElementById('createProfit').addEventListener('click', selectTypeOfProfit);
